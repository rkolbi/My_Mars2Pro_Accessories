...
·  Keep your workspace environment, containing your printer, resin, and cleaning/UV curing station, at a stable room temperature not less the 72f - ideal being 75f to 85f. Cold resin presents two main issues, increased viscosity and slowed/unstable/unpredictable curing rates. Viscosity refers to the resistance to flow; the lower the viscosity, the easier it flows - we want low viscosity. When the resin is cold and thick, it is hesitant to mix well and, more importantly, increases build-plate and part suction to the FEP, leading to potential failures. During these colder operations, your printer's FEP may have less flexibility and elasticity, further increasing the potential of failure. For the curing rate, the higher the temperature, the faster the resin will cure. On the flip side, increased exposure times compensate when the temperatures are below the recommended temperature envelope, but the required exposure can be unpredictable and change as the print progresses. Most resin manufacturers provide recommended/ideal operating temperatures; some even offer recommendations for colder environments. Additionally, higher room temps may be necessary to achieve complete polymerization, depending on the resin used. Always visit the manufacturers' website for the most current guidance as each type and color of resin can, and most likely will, have different requirements. With that, make sure you are using the recommended settings for your printer.  
